...
const examples = {
  curl: `curl -X POST https://api.pdfapi.io/v1/pdf \\
  -H "x-api-key: pk_live_xxx" \\
  -H "Content-Type: application/json" \\
  -d '{"html": "<h1>Hello World</h1>"}' \\
  --output document.pdf`,

  node: `const response = await fetch('https://api.pdfapi.io/v1/pdf', {
  method: 'POST',
  headers: {
...
pdf = response.content`,
  ...
  php: `$response = file_get_contents('https://api.pdfapi.io/v1/pdf', false,
