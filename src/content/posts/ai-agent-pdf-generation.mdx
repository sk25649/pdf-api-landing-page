...
The agent receives 3 free credits on registration (10 with a valid email address) and can top up by sending USDC to its wallet address on Base mainnet. The balance is checked every 10 minutes and credits are added automatically.
