...
- 3 free credits to start (10 with email)
...
Get a key at [docapi.co/signup](https://www.docapi.co/signup) — 3 free calls to start (10 with email), no credit card required. Agents can self-register at `/api/register`.
